...
line_bot_api.push_message('Ue8e85ddfa7ca3ba12ace6b481ce59d3a', TextSendMessage(text='你可以開始了'))
...
def handle_message(event):
    ...
    line_bot_api.reply_message(event.reply_token,TextSendMessage(message,'的英文定義是'))
    with open('diction6700.json',mode='r+',encoding='UTF-8') as file:
        data=json.load(file)
    line_bot_api.reply_message(event.reply_token,TextSendMessage(data[message][0]))
